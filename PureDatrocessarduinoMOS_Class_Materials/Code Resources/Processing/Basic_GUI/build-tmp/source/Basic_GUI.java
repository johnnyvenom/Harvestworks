...
public class Basic_GUI extends PApplet {
...
public void makeByte(){
  ...
  cmd = PApplet.parseByte(PApplet.parseByte(button1.state) | PApplet.parseByte(button2.state) << 1 | PApplet.parseByte(button3.state) << 2 | PApplet.parseByte(button4.state) << 3); 
...
class Button {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Basic_GUI" };
    if (passedArgs != null) {
